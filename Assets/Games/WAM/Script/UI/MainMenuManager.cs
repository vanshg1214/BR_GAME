...
namespace WhackAMole.UI
{
    ...
    public class MainMenuManager : MonoBehaviour
    {
        ...
        [UnityEngine.Serialization.FormerlySerializedAs("duration1MinButton")]
        [SerializeField] private Button easyDifficultyButton;

        [UnityEngine.Serialization.FormerlySerializedAs("duration3MinButton")]
        [SerializeField] private Button mediumDifficultyButton;

        [UnityEngine.Serialization.FormerlySerializedAs("duration5MinButton")]
        ...
        private void Start()
        {
            ...
            if (easyDifficultyButton != null) easyDifficultyButton.onClick.AddListener(SetDifficultyEasy);
            if (mediumDifficultyButton != null) mediumDifficultyButton.onClick.AddListener(SetDifficultyMedium);
            if (hardDifficultyButton != null) hardDifficultyButton.onClick.AddListener(SetDifficultyHard);
            ...
            if (difficultyProfile != null)
            {
                ...
                UpdateDifficultyVisuals(difficultyProfile.selectedDifficulty);
                UpdateToggleVisuals();
            }
        }
        ...
        private void UpdateDifficultyVisuals(GameDifficulty difficulty)
        {
            SetButtonHighlight(easyDifficultyButton, difficulty == GameDifficulty.Easy);
            SetButtonHighlight(mediumDifficultyButton, difficulty == GameDifficulty.Medium);
            SetButtonHighlight(hardDifficultyButton, difficulty == GameDifficulty.Hard);
        }
        ...
        public void SetDifficultyEasy()
        {
            if (difficultyProfile != null)
            {
                difficultyProfile.selectedDifficulty = GameDifficulty.Easy;
                Debug.Log("[MainMenuManager] Difficulty set to Easy");
                UpdateDifficultyVisuals(GameDifficulty.Easy);
            }
        }
        ...
        public void SetDifficultyMedium()
        {
            if (difficultyProfile != null)
            {
                difficultyProfile.selectedDifficulty = GameDifficulty.Medium;
                Debug.Log("[MainMenuManager] Difficulty set to Medium");
                UpdateDifficultyVisuals(GameDifficulty.Medium);
            }
        }
        ...
        public void SetDifficultyHard()
        {
            if (difficultyProfile != null)
            {
                difficultyProfile.selectedDifficulty = GameDifficulty.Hard;
                Debug.Log("[MainMenuManager] Difficulty set to Hard");
                UpdateDifficultyVisuals(GameDifficulty.Hard);
            }
        }
